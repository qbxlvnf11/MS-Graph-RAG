import custom_init_config.defaults as defs
from custom_init_config.defaults import (
...
models:
  {defs.DEFAULT_CHAT_MODEL_ID}:
    ### Options: "openai_chat", "on_promise"
    ...
    api_key: ${{API_KEY}} # set this in the generated .env file
    # audience: "https://cognitiveservices.azure.com/.default"
    # organization: <organization_id>
    ### GPT Model
    model: {defs.DEFAULT_CHAT_MODEL}
    ### TODO: On-Promise Model
    # on_promise_model: ""
