...
from rag_lib.language_model.protocol import ChatModel, EmbeddingModel
from rag_lib.language_model.providers.fnllm.models import (
...
class ModelFactory:
    ...
    @classmethod
    def register_onpromise(cls, model_type: str, creator: Callable[..., ChatModel]) -> None:
        """Register a On-promise LLM implementation."""
...
ModelFactory.register_onpromise(
    ModelType.OnPromise, lambda **kwargs: OnPromiseLLM(**kwargs)
)