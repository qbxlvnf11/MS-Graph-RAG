...
from rag_lib.config.models.chunking_config import ChunkingConfig, ChunkStrategyType
from rag_lib.index.operations.chunk_text.typing import (
    ChunkInput,
    ChunkStrategy,
)
...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        case ChunkStrategyType.tokens:
            from rag_lib.index.operations.chunk_text.strategies import run_tokens

            return run_tokens
        case ChunkStrategyType.sentence:
            # NLTK
            from rag_lib.index.operations.chunk_text.bootstrap import bootstrap
            from rag_lib.index.operations.chunk_text.strategies import run_sentences
